...
/*Step 2, Sign Up Component:
  ...
  In your component body, and before your return statement, define an async function called handleSubmit. Define this function to take an event and call preventDefault() on it, to prevent our page refresh. For now, also console.log a short message.
  ...
  Pass the error.message to the setError function. This is to store a server error in the application and display it. 
  Write the fetch request under the handleSubmit function and within the try statement. Use the provided API url. 
  To send info to the API, use a POST request. Pass along the username and password state values. 
